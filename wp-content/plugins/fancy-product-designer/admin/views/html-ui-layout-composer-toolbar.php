						...
						<div class="radykal-columns-two">
							...
							<div class="radykal-form-group">
								...
								<select name="views_selection_pos">
									<option value="fpd-views-inside-top"><?php _e('Top-Left Horizontal', 'radykal'); ?></option>
									<option value="fpd-views-inside-right"><?php _e('Top-Right Vertical', 'radykal'); ?></option>
									<option value="fpd-views-inside-bottom"><?php _e('Bottom-Right Horizontal', 'radykal'); ?></option>
									<option value="fpd-views-inside-left" selected=""><?php _e('Bottom-Left Vertical', 'radykal'); ?></option>
