...
function radykalModalBox(type) {
	...
	return jQuery('body').append('<div class="radykal-dialog-wrapper radykal-visible"><div class="radykal-dialog-box radykal-'+type+'"><div class="radykal-content"></div><div class="radykal-buttons"><a href="#" class="radykal-button radykal-button-submit">'+submitBtnText+'</a><a href="#" class="radykal-button radykal-button-cancel">'+cancelBtnText+'</a></div></div></div>').find('.radykal-dialog-box');
