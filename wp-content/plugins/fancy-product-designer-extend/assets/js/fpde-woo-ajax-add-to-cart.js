jQuery( function( $ ) {
	 ...
	 */
	var fpdeAddToCartHandler = function() {
		$( document.body )
	 ...
	 */
	fpdeAddToCartHandler.prototype.onAddToCart = function( e ) {
		e.preventDefault();
		...
		if ( variation_id != '' ) {
			$.ajax ({
				...
				type: 'POST',
				data : {
			        action : 'fpde_add_cart_single_product',
	 ...
	 */
	fpdeAddToCartHandler.prototype.updateButton = function( e, fragments, cart_hash, $button ) {
	...
	/**
	 * Init fpdeAddToCartHandler.
	 */
	new fpdeAddToCartHandler();
});