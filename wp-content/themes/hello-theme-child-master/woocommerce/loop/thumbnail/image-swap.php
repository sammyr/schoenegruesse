...
$image_caption1 = $image->post_excerpt;


$image = get_post($secondary_img_id);
$image_caption2 = $image->post_excerpt;

// Image args
$first_img = array(
    'class'         => 'woo-entry-image-main',
    'alt'           => get_the_title(),
    'title'			=> $image_caption2, 
);
...
if ( $secondary_img_id ) : ?>
	...
	<div class="woo-entry-image-swap woo-entry-image clr">
		...
		<a href="<?php the_permalink(); ?>" class="woocommerce-LoopProduct-link">
			<?php
			// Main Image
			echo wp_get_attachment_image( $attachment, 'medium', '', $first_img ); ?>
			<?php
			// Secondary Image
			echo wp_get_attachment_image( $secondary_img_id, 'medium', '', $second_img ); ?>
		</a>
